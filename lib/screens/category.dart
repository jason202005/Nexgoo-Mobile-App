...
class _CatogaryState extends State<Category> {
  Container _buildGFCard(String imageurl, String iconImage, String titlet, String subtitlet, String contentt){
    return Container(child: GFCard(
